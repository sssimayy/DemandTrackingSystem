...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="page-head-line">Fatura Bilgileri</h3>

						<style>
									#my_centered_buttons_older { margin: auto; width: 100px;}
						</style>
                       <form action="faturagenerat_pdf.php"  method="post">
					   <br><font size="4"><strong>Fatura Tarihi : </strong></font><input type="date" name="dday"><br><br>
					   
					   <font size="4"><strong>İrsaliye No:  </strong></font><br><br>
                 ...
                 $sonuckod->setFetchMode(PDO::FETCH_ASSOC);
				  ...
				  {
				   echo "<tr><td><input type='checkbox' name='bayiler[]' value='".$row['name']."'/>".$row['id']."</td><td>".$row['name']."</td><td>".$row['route']."</td></tr>";
